...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'root@172.17.105.125';
   ...
   * by SERVER_NAME is used or '172.17.105.125.localdomain'.
   * @var string
   */
  public $Hostname          = '';
 ...
 */
  ...
  */
  ...
  /**
   * Returns the server hostname or '172.17.105.125.localdomain' if unknown.
   * @access protected
   * @return string
   */
  protected function ServerHostname() {
    if (!empty($this->Hostname)) {
      ...
      $result = '172.17.105.125.localdomain';
    }
